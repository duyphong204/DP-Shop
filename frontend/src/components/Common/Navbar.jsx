...
const Navbar = () => {
  ...
  return (
    <>
      {/* ================= Navbar ================= */}
      <nav className="container mx-auto flex items-center justify-between py-4 px-4 sm:px-6 gap-4">
        {/* Logo */}
        ...
        <div className="flex items-center justify-around">
          ...
          {user?.role==="admin" &&(
            <Link to='admin' className="flex flex-col items-center text-gray-700">
              <div className="w-6 h-6 text-white rounded-2xl bg-black flex items-center justify-center font-bold text-[10px]">
                A
              </div>
