    ...
    <div className='bg-rabbit-red text-white'>
        <div className='container mx-auto flex justify-between items-center py-3 px-4'>
            <div className='hidden md:flex items-center space-x-4'>
                <a href="https://www.facebook.com/phong.duy.316058" target="_blank" className='hover:text-gray-300'>
                    <TbBrandFacebook className='h-5 w-5'/>
                </a>
                <a href="https://www.instagram.com/dndp_04/" target="_blank" className='hover:text-gray-300'>
