    ...
    <section className='py-16 px-4 lg:px-0'>
      ...
      <div className='container mx-auto flex flex-row gap-6 sm:gap-8'>  
        ...
        <div className='relative w-1/2'>
          ...
          />
          <div className='absolute bottom-4 sm:bottom-8 left-4 sm:left-8 bg-white bg-opacity-70 p-3 sm:p-4 rounded-2xl'>
            <h2 className='text-sm sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3'>
              Women's Collection
            </h2>
            <Link to="/collections/all?gender=Women" className='text-gray-900 underline text-sm'>
              Shop Now
            </Link>
          </div>
        </div>
        ...
        <div className='relative w-1/2'>
          ...
          <div className='absolute bottom-4 sm:bottom-8 left-4 sm:left-8 bg-white bg-opacity-70 p-3 sm:p-4 rounded-2xl'>
            ...
            <Link to="/collections/all?gender=Men" className='text-gray-900 underline text-sm'>
              Shop Now
            </Link>
          </div>
        </div>
